export const translations = {
  zh: {
    ...
    // Profile
    profile: '个人设置',
    profile_hint: '填写信息后，AI生成的日记会更贴近你的风格',
    nickname: '昵称',
    gender: '性别',
    birth_year: '出生年份',
    personality: '性格特点',
    interests: '兴趣爱好',
    self_description: '关于我',
    gender_male: '男',
    gender_female: '女',
    gender_other: '其他',
    save: '保存',
    save_success: '保存成功',
    nickname_placeholder: '你喜欢被叫什么？',
    birth_year_placeholder: '例如：2000',
    personality_placeholder: '例如：开朗、内敛、爱冒险...',
    interests_placeholder: '例如：摄影、旅行、读书、咖啡...',
    self_description_placeholder: '用几句话介绍一下自己...',
    optional: '选填',
    // Months
  ...
  en: {
    ...
    // Profile
    profile: 'Settings',
    profile_hint: 'Help AI write diary entries that sound like you',
    nickname: 'Nickname',
    gender: 'Gender',
    ...
    save: 'Save',
    save_success: 'Saved!',
    nickname_placeholder: 'What do you like to be called?',
    birth_year_placeholder: 'e.g. 2000',
    personality_placeholder: 'e.g. outgoing, introverted, adventurous...',
    interests_placeholder: 'e.g. photography, travel, reading, coffee...',
    self_description_placeholder: 'Tell us a little about yourself...',
    optional: 'Optional',
    // Months
